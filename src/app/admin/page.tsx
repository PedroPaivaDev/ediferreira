...
const Admin = () => {
  ...
  return (
    <main className={`py-16 ${contentDB ? 'opacity-100' : 'opacity-0'} duration-1000`}>
      ...
      <>
        <p className='w-full max-w-4xl px-5 pb-10 text-left'>Bem vinda, Edi.</p>
        <div className='w-full max-w-4xl px-5 pb-10 flex flex-col justify-start items-start gap-3'>
        ...
        <div className='w-full max-w-4xl px-5 pb-10 flex flex-col justify-start items-start gap-3'>
          <label htmlFor="home&photoEdi">Escolha uma nova foto para a sessão &quot;sobre&quot;</label>
          <input
        ...
        <form className='w-full flex flex-col justify-start items-start gap-10 max-w-4xl px-5' onSubmit={handleSubmit}>
          ...
          <div id='servicesContent' className='w-full flex flex-col justify-start items-start gap-5'>
            ...
            <TextArea name='about/servicesText&firstParagraph' label={`Primeiro texto:`} placeholder={contentDB.about.servicesText.firstParagraph}/>
            <TextArea name='about/servicesText&secondParagraph' label={`Segundo texto:`} placeholder={contentDB.about.servicesText.secondParagraph}/>
            <TextArea name='about/servicesText&thirdParagraph' label={`Terceiro texto:`} placeholder={contentDB.about.servicesText.thirdParagraph}/>
