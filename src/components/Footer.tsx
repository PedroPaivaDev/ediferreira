...
const Footer = () => {
  return (
    <footer className='relative bg-mood-secondary text-mood-light'>
      <a
        href={`https://pedropaiva.vercel.app`} target="_blank"
        className="absolute bottom-2 text-sm text-thin font-sans text-mood-quintenary hover:text-mood-light duration-300"
      >
        Desenvolvido por PedroPaivaDev
      </a>
      <button onClick={scrollToTop} className='
        group absolute top-0 cursor-pointer
        text-mood-tertiary hover:text-mood-primary duration-300
        flex flex-col justify-center items-center
      '>
        <svg xmlns="http://www.w3.org/2000/svg" width="30" height="30" viewBox="0 0 256 256"
          className='fill-mood-tertiary group-hover:fill-mood-primary duration-300'
        >
