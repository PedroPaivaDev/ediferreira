...
const Header = () => {
  ...
  return (
    ...
    `}>
      <nav className='flex justify-center items-center w-full max-w-[900px]'>
        <ul className='flex justify-center items-center w-full flex-1 gap-5 m-5'>
        ...
        <a href="#home" className='w-14 h-14'>
          <Image
