...
const WhatsappButton = () => {
  ...
  return (
    ...
    //   </svg>
    // </a>
    <a href={contentDB?.contacts.social['1whatsapp'].url} aria-label='Conversar pelo Whatsapp' target="_blank" className='fixed bottom-3 right-3 rounded-full p-2 z-10 bg-mood-primary'>
      <svg xmlns="http://www.w3.org/2000/svg"
        width="40" height="40" viewBox="0 0 256 256"
